...
# https://merge.metrumrg.com/expo3-nonmem-bayes/posts/model-management-demo.html
#
...
# Run the models
# WARNING: these particular models take up to ~1.5 hours to run on 4 cores
walk(
  mods,
  ~ submit_model(.x, .bbi_args = args, .overwrite = TRUE)
)
